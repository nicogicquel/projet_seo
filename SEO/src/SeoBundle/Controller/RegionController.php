...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('SeoBundle:Region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('SeoBundle\Form\RegionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('SeoBundle\Form\RegionType', $region);
