...
class StatutController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuts = $em->getRepository('SeoBundle:Statut')->findAll();
    ...
    {
        $statut = new Statut();
        $form = $this->createForm('SeoBundle\Form\StatutType', $statut);
    ...
    {
        $deleteForm = $this->createDeleteForm($statut);
        $editForm = $this->createForm('SeoBundle\Form\StatutType', $statut);
