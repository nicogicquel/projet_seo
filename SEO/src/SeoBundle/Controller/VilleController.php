...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $villes = $em->getRepository('SeoBundle:Ville')->findAll();
    ...
    {
        $ville = new Ville();
        $form = $this->createForm('SeoBundle\Form\VilleType', $ville);
    ...
    {
        $deleteForm = $this->createDeleteForm($ville);
        $editForm = $this->createForm('SeoBundle\Form\VilleType', $ville);
