...
class DepartementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departements = $em->getRepository('SeoBundle:Departement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SeoBundle\Form\DepartementType', $departement);
    ...
    {
        $deleteForm = $this->createDeleteForm($departement);
        $editForm = $this->createForm('SeoBundle\Form\DepartementType', $departement);
